...
model_name = "gpt4o"
file = '../data/llm_prompt_outputs_v2/gpt4o_yearly_combined.csv'
...
df_combined_model['low'] = df_combined_model['ad_hoc_error'].apply(bool_low_20)
...
with open(f'./regressions_v2/result_summary_mcap_{model_name}_20.txt', "w") as f:
